defmodule ExFussballDeScraper.Downloader.UserAgent do
  @moduledoc """
  Holds a list of user agents and returns a random on.
  """
  ...
  @user_agents [
    ...
    "Mozilla/5.0 (Windows NT 6.3; WOW64; rv:40.0) Geckos/20100101 Firefox/40.0",
  ...
  @doc """
  Returns the list of user agent binaries (`get(:all)`), 
  or a random user agent (`get(:random)`)..

  ## Example usage
  iex> ExFussballDeScraper.Downloader.UserAgent.get(:all) |> is_list()
  true
  iex> ExFussballDeScraper.Downloader.UserAgent.get(:all) |> Enum.count()
  1000
  iex> ExFussballDeScraper.Downloader.UserAgent.get(:random) |> is_binary()
  true
  iex> Enum.member?(ExFussballDeScraper.Downloader.UserAgent.get(:all), ExFussballDeScraper.Downloader.UserAgent.get(:random))
  true
  """
  def get(:all) do
    @user_agents
